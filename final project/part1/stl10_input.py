...
#DATA_PATH = 'E:/PhD-term3/TAlab5/team20/data/stl10_binary/train_X.bin'
DATA_PATH = './data/stl10_binary/train_X.bin'

# path to the binary train file with labels
#LABEL_PATH = 'E:/PhD-term3/TAlab5/team20/data/stl10_binary/train_y.bin'
...
def keep_relevant_images(images, labels, relevant_labels):
    # rele = np.array([1, 2, 9, 7, 3])
...
if __name__ == "__main__":
    ...
    print(used_labels.shape)
    print(used_images.shape)
